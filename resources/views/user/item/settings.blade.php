                        ...
                        <div class="col-lg-6 offset-lg-3">
                            <form id="ajaxForm" class="" action="{{ route('user.item.settings') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-warning mb-0">{{ __('If you enable catalog mode, then pricing, cart, checkout option of items will be removed. But item & item details page will remain.') }}</p>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Rating System') }} **</label>
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
