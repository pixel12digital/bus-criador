    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="{{route('user.job.index') . '?language=' . request()->input('language')}}">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="deadline" type="text" class="form-control datepicker ltr" name="deadline" value="{{$job->deadline}}" placeholder="{{__('Enter application deadline')}}" autocomplete="off">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="experience" value="{{$job->experience}}" placeholder="{{__('Enter years of experience')}}">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="job_location" value="{{$job->job_location}}" placeholder="{{__('Enter job location')}}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control ltr" name="email" value="{{$job->email}}" placeholder="{{__('Enter email address')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control ltr" name="serial_number" value="{{$job->serial_number}}" placeholder="{{__('Enter Serial Number')}}">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="meta_keywords" value="{{$job->meta_keywords}}" placeholder="{{__('Enter meta keywords')}}" data-role="tagsinput">
                             </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>{{__('Meta Description')}}</label>
                                <textarea class="form-control" name="meta_description" rows="3" placeholder="{{__('Enter meta description')}}">{{$job->meta_description}}</textarea>
                             </div>
                        </div>
                    </div>
                </form>
