    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>{{ __('Criar Segmento') }}</h3>
                <p class="text-subtitle text-muted">{{ __('Crie um novo segmento para a home page') }}</p>
            </div>
                ...
                <form action="{{ route('admin.segments.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('serial_number') is-invalid @enderror" 
                                       id="serial_number" name="serial_number" value="{{ old('serial_number', 0) }}" required>
                                @error('serial_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('hero_section_title') is-invalid @enderror" 
                                       id="hero_section_title" name="hero_section_title" value="{{ old('hero_section_title') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('hero_section_subtitle') is-invalid @enderror" 
                                       id="hero_section_subtitle" name="hero_section_subtitle" value="{{ old('hero_section_subtitle') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('hero_section_text') is-invalid @enderror" 
                                  id="hero_section_text" name="hero_section_text" rows="3">{{ old('hero_section_text') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('hero_section_button_text') is-invalid @enderror" 
                                       id="hero_section_button_text" name="hero_section_button_text" value="{{ old('hero_section_button_text') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('hero_section_button_url') is-invalid @enderror" 
                                       id="hero_section_button_url" name="hero_section_button_url" value="{{ old('hero_section_button_url') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('hero_section_secound_button_text') is-invalid @enderror" 
                                       id="hero_section_secound_button_text" name="hero_section_secound_button_text" value="{{ old('hero_section_secound_button_text') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('hero_section_secound_button_url') is-invalid @enderror" 
                                       id="hero_section_secound_button_url" name="hero_section_secound_button_url" value="{{ old('hero_section_secound_button_url') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('custom_css') is-invalid @enderror" 
                                  id="custom_css" name="custom_css" rows="5">{{ old('custom_css') }}</textarea>
                        @error('custom_css')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('custom_js') is-invalid @enderror" 
                                  id="custom_js" name="custom_js" rows="5">{{ old('custom_js') }}</textarea>
                        @error('custom_js')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> {{ __('Salvar Segmento') }}
                        </button>
